...
% dlmwrite('D:\matlab\workspace\vot-toolkit-master\vot_workspace\x.txt', img);
% dlmwrite('D:\matlab\workspace\vot-toolkit-master\vot_workspace\class.txt', class(img));
...
% dlmwrite('D:\matlab\workspace\vot-toolkit-master\vot_workspace\x.txt', sz_window);
% dlmwrite('D:\matlab\workspace\vot-toolkit-master\vot_workspace\class.txt', class(sz_window));
...
vgg16net = load('E:\tracker_benchmark_v1.0\trackers\deepBACF_FS\model\imagenet-vgg-verydeep-16.mat');
